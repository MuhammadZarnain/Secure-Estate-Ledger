        ...
        try {
            if (contract) {
                const transaction = await contract.registerUser(
                    state.cnic.toString(),
                    state.name.toString(),
                    state.fname.toString(),
                    phone_number.toString(),
                    state.email.toString(),
                    state.password.toString(),
                    state.paddress.toString(),
                    state.caddress.toString()
                );
    ...
    const verifyCode = async () => {
        try {
            ...
            if (response.ok) {
                ...
                window.alert("Error verifying code");
            }
        } catch (error) {
            ...
            <div className='relative w-full h-full bg-zinc-400/80'>
                <div className='flex justify-center items-center h-full'>
                    <form className='max-w-[600px] w-screen mx-auto rounded-[40px] bg-white m-8' onSubmit={handleRegistration}>
                        <h2 className='text-2xl font-bold text-center py-8'>Registration</h2>
                        ...
                        <div className='flex justify-around mr-[50px] py-2'>
                            <div className='flex flex-col'>
                                ...
                                <input id='cnic' className='border rounded-[40px] relative bg-gray-100 p-2' name='cnic' value={cnic} type='text' onChange={handleChange}  placeholder='3740511914716'/>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <input id='phone-number' className='border rounded-[40px] relative bg-gray-100 p-2' name='phone_number' value={phone_number} onChange={(e) => setPhoneNumber(e.target.value)} type='tel' placeholder='+923311212725' />
                        ...
                        <div className='flex justify-around mr-[50px] py-2'>
                            <div className='flex flex-col'>
                                ...
                                <input id='email' className='border rounded-[40px] relative bg-gray-100 p-2' name='email' type='email' value={email} onChange={handleChange} placeholder='name@hotmail.com' />
                                {errors.email && <span className='text-red-700'>{errors.email}</span>}
                            </div>
                            <div className='flex flex-col'>
                                <label htmlFor="password" className='text-green-700'>Password</label>
                                <input id='password' className='border rounded-[40px] relative bg-gray-100 p-2' name='password' type='password' value={password} onChange={handleChange} placeholder='xxx-xxx-xxx' />
                        ...
                        <button type='submit'  className=' w-[200px] rounded-[40px]  h-[40px] ml-45  items-center bg-green-600 hover:bg-green-900  relative  text-white'>Register</button>
                        <p className='text-center p-8'>Already have an account? <a className='text-green-700 underline' href='/'>Sign in</a></p>
                    </form>
                </div>
            </div>
        </div>
