...
<div className='flex flex-col'>
        ...
        <input id='landId' className='border rounded-[40px] bg-white p-2 text-left' name='landID' type='number' placeholder='Khasra Number' value={landID} onChange={handleChange} required/>
     
    </div>
    <div className='flex flex-col mr-4 '>
        <label htmlFor='fname' style={{ color: 'green' }}><b>Full Name </b></label>
        <input id='fname' className='border rounded-[40px] bg-white p-2 text-left' name='fname' type='text' placeholder='John Carter' value={fname} onChange={handleChange} required/>
        {errors.fname && <span className='text-red-700'>{errors.fname}</span>}
    </div>
    <br /> <br/>
    <div className='flex flex-col'>
        <label style={{ color: 'green' }}><b>Father Name</b></label>
        <input id='fathername' className='border rounded-[40px] bg-white p-2 text-left' name='fathername' type='text' placeholder='John Carter'value={fathername} onChange={handleChange} required/>
...
<div className='flex flex-row mb-4 text-left '>
    <div className='flex flex-col mr-4'>
        ...
        <input id='cnic' className='border rounded-[40px] bg-white p-2 text-left' name='cnic' type='text' placeholder='40579-1191471-9' value={cnic} onChange={handleChange} required/>
        {errors.cnic&& <span className='text-red-700'>{errors.cnic}</span>}
    </div>
    <div className='flex flex-col'>
        <label htmlFor='size' style={{ color: 'green' }}><b>Size</b> </label>
        <input id='size' className='border rounded-[40px] bg-white p-2 text-left' name='size' type='text' placeholder='Square meters' value={size} onChange={handleChange} required/>
        {errors.size && <span className='text-red-700'>{errors.size}</span>}
    </div>
    <div className='flex flex-col'>
        <label htmlFor='location' style={{ color: 'green' }}><b>Location</b> </label>
        <input id='location' className='border rounded-[40px] bg-white p-2 text-left' name='location' type='text' placeholder='Street,Area' value={location} onChange={handleChange} required/>
 ...
 <div  className='flex flex-col mb-4 text-left'>
                ...
                <input  id='caddress' className='border rounded-[20px]  bg-white p-10 ' name='caddress'  type='text' placeholder='Hno,street,religion'value={caddress} onChange={handleChange} required/>
                ...
                <input  id='paddress' className='border rounded-[20px]  bg-white p-10 ' name='paddress'  type='text' placeholder='Hno,street,religion' value={paddress} onChange={handleChange} required/>
                {errors.paddress && <span className='text-red-700'>{errors.paddress}</span>}
                <label htmlFor='email' style={{ color: 'green' }}><b> Email </b></label>
                <input  id='email' className='border rounded-[40px]  bg-white p-2 ' name='email'  type='text' placeholder='Johncarter@gmail.com' value={email} onChange={handleChange} required/>
