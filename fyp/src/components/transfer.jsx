...
export default function tr_land({ contract, userAddress }) {
    return (
      <div className="bg-white flex flex-col items-stretch">
        <div className="w-full max-md:max-w-full">
          ...
          <Sidebar contract={contract} userAddress={userAddress}/>
            ...
            <div className="flex flex-col self-center px-5 py-12 w-full bg-white max-w-[1205px] max-md:max-w-full">
      ...
      <div className="mt-2 text-3xl font-bold leading-8 text-center text-zinc-800 max-md:max-w-full">
        Transfer of Land Now Get Easy
      </div>
      <div className="self-center mt-14 w-full max-w-[986px] max-md:mt-10 max-md:max-w-full">
          ...
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow text-black max-md:mt-10">
              ...
              <div className="mt-5 text-sm leading-5">
                ...
                <br />
                Payment of the Stamp Duty Capital Value Tax and Registration Fee
                at Bank of Punjab Only
                <br />
                Hire the Deed Writer or Lawyer by the Customer
                <br />
                Execution & Registration of a Deed Before Registration Authority
                & Mutation in Revenue Record at Sub Registrar Office
                <br />
      ...
      <div className="justify-center self-center px-5 py-2.5 mt-48 mb-3 text-base font-medium tracking-wide leading-4 text-white whitespace-nowrap bg-[#197902] rounded-[40px] max-md:mt-10">
        <a href="/landTransfer">Transfer Land</a>
      </div>
    </div>
            </div>
            </div>
