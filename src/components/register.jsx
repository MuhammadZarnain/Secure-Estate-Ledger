...
const Register=({ contract })=>{
    ...
    const{name,fname,cnic,paddress,email,password,phone,caddress} = state;
    ...
    <div className='flex justify-center items-center h-full '>
        <form className=' max-w-[600px]  w-screen mx-auto rounded-[40px] bg-white m-8 ' onSubmit={handleRegistration}>
            ...
            <div  className='flex flex-col '>
                ...
                <input className='border  rounded-[40px] relative bg-gray-100 p-2' name='phone' value={phone} type='text'  onChange={handleChange}/>
            ...
            <button type='submit' className='w-[200px] rounded-[40px]  h-[40px] ml-[180px] mr-[180px]items-center bg-green-600 hover:bg-green-900  relative  text-white'>Register</button>
